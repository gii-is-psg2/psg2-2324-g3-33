        ...
        <Table aria-label="vets" className="mt-4">
          <thead>
            <tr>
              ...
              <th width="20%" style={{ backgroundColor: "#f5deb3" }}>Specialties</th>
              <th width="15%" style={{ backgroundColor: "#f5deb3" }}>Clinic</th>
              <th width="15%" style={{ backgroundColor: "#f5deb3" }}>User</th>
              <th width="20%" style={{ backgroundColor: "#f5deb3" }}>Actions</th>
            </tr>
          </thead>
          <tbody>{vetList}</tbody>
        </Table>
